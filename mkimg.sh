...
if [ -f $IMGNAME ]; then
	...
	sync
	cp boot/* sdcard/boot
	cp ../../../kernel/arpi/arch/arm64/boot/Image.gz sdcard/boot
	cp ../../../kernel/arpi/arch/arm64/boot/dts/broadcom/bcm2711-rpi-4-b.dtb sdcard/boot
	mkdir -p sdcard/boot/overlays
	cp ../../../kernel/arpi/arch/arm64/boot/dts/overlays/vc4-kms-v3d-pi4.dtbo sdcard/boot/overlays
